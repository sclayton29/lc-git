...
### Today's Focus
Today we are going to be working with git only via GitHub. You can add git/version control processes to your local machine via the command line and/or GitHub Desktop. I'd be happy to provide more information about that process for anyone who is interested after the workshop.
